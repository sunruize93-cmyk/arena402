...
export const ZH_CN_PLAYER_EXPERIENCE: Record<string, string> = {
  ...
  'Spin memorial coin': '拨动纪念币',
  'Drag or flick coin': '拖动或拨动纪念币',
  'Founding #': '创始编号 #',
  ...
  DEAL: '成交',
  CHAIN: '上链',
  'Seller reviewing': '卖方审阅中',
  'Seller selected': '已选择卖方',
  Bargaining: '协商中',
  'Terms accepted': '条款已接受',
  Authorizing: '授权中',
  'Sent to chain': '已提交上链',
  'Chain confirmed': '链上已确认',
  'Inventory moved': '库存已变更',
  'No deal': '未成交',
